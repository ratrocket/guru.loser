...
////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////
// First way of doing this is below.
...
//}
//
//type CoverDetails []CoverDetail
//
//func main() {
//	var imgData = flag.String("img", "image-sources", "image paths file")
//	var tmplPath = flag.String("tmpl", "main.tmpl", "template file")
//	flag.Parse()
//
//	covers := make(CoverDetails, 0)
//
//	imgSrcs, err := os.Open(*imgData)
//	if err != nil {
//		log.Fatal(err)
//	}
//	defer imgSrcs.Close()
//
//	scanner := bufio.NewScanner(imgSrcs)
//	for scanner.Scan() {
//		covers = append(covers, CoverDetail{Path: scanner.Text()})
//	}
//
...
//	}
//
//	//for _, c := range covers { fmt.Println(">", c.Path, "<") }
//
//	tmpl := template.Must(template.ParseFiles(*tmplPath))
//
//	if err := tmpl.Execute(os.Stdout, covers); err != nil {
//		log.Fatalf("template execution: %s", err)
//	}
//}
